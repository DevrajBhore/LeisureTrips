          ...
          <Col lg='8'>
            <div className="tour__content">
              ...
              <div className="tour__info">
                ...
                <div className="tour__extra-deails">
                  <span><i class="ri-map-pin-user-fill"></i>{title}</span>
              ...
              <div className="tour__review mt-4">
                ...
                <Form onSubmit={submitHandler}>
                  ...
                  <div className="review__input">
                    <input type="text" ref={reviewMsgRef} placeholder="share your thougths" className='ip' />
                        ...
                        <div className="w-100">
                          <div className='d-flex align-items-center justify-content-between'>
                            <div>
                              <h5>Rohan</h5>
                                <p>
                                {new Date("03-03-2025").toLocaleDateString(
